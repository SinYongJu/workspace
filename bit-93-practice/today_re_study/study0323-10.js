/*
객체의 용도
여러 개의 데이터를 한 다위로 묶어서 다루고 싶을 때 => 배열과 객체
각각의 값을 코드에서 쉽게 구분하고 싶을 때 => 객체 왜? 이름으로 구분하기가
쉽다.
...
console.log("홍길동3의 총점은?", scores2[3].math)

// [{}] 배열안에 객체를 집어 넣을 수 있음 대신 안에 잇는 값의 주소가 없는지
// 찾지를 못함! undefiend
